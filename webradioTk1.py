...
class Interface(Tk):
    ...
    def initialize(self):
        ...
        self.quitter = Button(self.cadre1, text="Quitter", command=self.Stop, fg="red", bg="gray25")
        ...
        self.volume = Scale(self.cadre1, orient="vertical", from_=100, to=0, resolution=1, length=60, label="Volume", variable=self.v, command=self.Amp)
        self.volume.set(80)
